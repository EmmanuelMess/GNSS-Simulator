...
from src.conversions import ecef2llh, ecef2aer
...
class IonosphericDelayTest(unittest.TestCase):
    def test_nighttime(self):
        ...
        delay = simulator._ionospheric_delay_calculation(satellites_ecef, receiver_ecef, time_gps)
    ...
    def test_paper(self):
        ...
        satellites_ecef = np.array([satellite_ecef], dtype=np.float64)
        aer = ecef2aer(receiver_ecef, satellite_ecef)
